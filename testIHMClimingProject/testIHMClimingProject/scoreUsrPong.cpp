...
scoreUsrPong::scoreUsrPong(QWidget* _parent) : parent(_parent)
{
	ui.setupUi(this);
	...
	connect(ui.pushButton_Back, &QPushButton::pressed, this, &scoreUsrPong::pushbackButton);
}

scoreUsrPong::~scoreUsrPong()
{
}

void scoreUsrPong::updateModel()
{
...
void scoreUsrPong::pushbackButton() {
	this->close();
	parent->show();
}